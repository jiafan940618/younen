...
public class OrderController {
	...
	public Object nextStep(Integer nextId, OrderVo orderVo) {
		System.out.println("nextId::"+nextId+"\t"+"id::"+(orderVo.getId()!=null?orderVo.getId():null));
		// 判断参数是否异常
	...
	@ResponseBody
	public ResultData<Object> getupload(MultipartHttpServletRequest request, HttpSession session)
