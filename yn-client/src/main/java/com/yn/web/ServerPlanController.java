...
public class ServerPlanController {
	...
	@ResponseBody
	public Object findAll(ServerPlanVo serverPlanVo,
	...
	public ResultData<Object> findServerPlan(NewServerPlanVo newserverPlanVo,
			@RequestParam("checkedId") List<Long> checkedId, @RequestParam("moneyTotal") String price, UserVo userVo,
			HttpSession session) {
