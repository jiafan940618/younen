...
public interface OrderPlanDao extends JpaRepository<OrderPlan, Long>, JpaSpecificationExecutor<OrderPlan> {
    ...
    @Query(value = "SELECT o.order_code,o.order_text ,p.battery_board_brand,p.battery_board_model,p.inverter_brand,p.inverter_model,a.apo_ids,o.war_period,p.id  FROM t_order o" 
