...
public class ServerVo extends QueryVo{
	...
	private Set<ServerApolegamyVo> serverApolegamy;
	...
	public Set<ServerApolegamyVo> getServerApolegamy() {
		return serverApolegamy;
	}
	public void setServerApolegamy(Set<ServerApolegamyVo> serverApolegamy) {
	...
	public Set<QualificationsVo> getQualifications() {
