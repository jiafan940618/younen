...
public class HttpClientUtil {
	...
	public static String sendRequest(String url, String json, String contentType) {
		...
		try {
			HttpPost httpPost = new HttpPost("https://mch.cspaying.com/cloud/cloudplatform/api/trade.html");
	...
	public static void main(String[] args) throws IOException {
		sendRequest("https://mch.cspaying.com/cloud/cloudplatform/api/trade.html", "{}",
