...
public class Station extends IDomain implements Serializable {
	...
	@Column(columnDefinition = "varchar(255) comment '[电站名称]'")
	...
	@Column(columnDefinition = "varchar(255) comment '[电站地址]'")
	...
	@JsonIgnoreProperties(value = {"user","serverQualifications","serverPlan","serverApolegamy"})
