...
public class Ammeter extends IDomain implements Serializable {
	...
	@Column(precision = 12, scale = 2, columnDefinition = "decimal(12,2) comment '[当前功率]'")
	...
	private String sim;
	@Column(precision = 12, scale = 2, columnDefinition = "decimal(12,2) comment '[初始电量]'")
	...
	@JsonIgnoreProperties(value = {"ammeter","order","user","server"})
